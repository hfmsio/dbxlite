/**
 * Static SQL completion items: keywords, functions, snippets.
 *
 * Verbatim move from `lib/sqlCompletions.ts` as part of Phase 1 of the
 * autocomplete redesign. Behavior unchanged. Per-dialect splits land
 * in Phase 2 (see `dialects/` subdir, currently empty).
 */
